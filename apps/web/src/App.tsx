...
function AppContent() {
  ...
  if (currentPath === '#profile') return <ProtectedRoute><ProfilePage /></ProtectedRoute>;
  ...
  return (
    <ProtectedRoute>
      ...
      {['#home', '#subjects', '#timetable', '#today', '#profile', '#login', '#register'].indexOf(currentPath) === -1 && <HomePage />}
    </ProtectedRoute>
  );
}
